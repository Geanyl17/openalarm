...
- An NFC tag mission: scan a tag in the alarm editor, put it somewhere away from your bed, and tap it to turn the alarm off. If NFC is off when the alarm rings, it's math instead.
- An Alertness mission, based on the reaction test sleep researchers use to measure drowsiness: tap as soon as a counter starts, 10 times in about 45 seconds. You pass when you're close to your own daytime speed, which you measure once in the alarm editor. After 3 failed tries, it's math instead.

...
|---|---|---|---|
| Icons: alarm, add, close, delete, keyboard, schedule | App icon, notification, app screens | [Material Icons](https://github.com/google/material-design-icons) by Google | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) |

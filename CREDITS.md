...
|---|---|---|---|
| Icons: alarm, add, close, delete, backspace, check | App icon, notification, app screens, math keypad | [Material Icons](https://github.com/google/material-design-icons) by Google | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) |

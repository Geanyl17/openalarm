...
| **Stroop** ("Colors" in the app) | The word "RED" is printed in blue, and you tap *blue*. Hard to do half asleep. | 2 |
...
│   └── missions/   # the missions: math, memory, reaction, Stroop, Lights On, Steps and NFC tag so far, camera missions next
...
- [x] Mission chains
- [x] Wake-up streaks
- [x] Missions: Stroop, Lights On, Steps, NFC Tag, and Reaction, a short version of the Alertness Gate
- [ ] Missions: the full Alertness Gate
- [ ] Submit to F-Droid
